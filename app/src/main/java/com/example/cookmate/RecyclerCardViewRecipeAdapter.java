...
public class RecyclerCardViewRecipeAdapter extends RecyclerView.Adapter<RecyclerCardViewRecipeAdapter.MyViewHolder> {
    ArrayList<Map<String, Object>> documentList;
    Context context;

    public RecyclerCardViewRecipeAdapter(Context context, ArrayList<Map<String, Object> > cards) {
        super();
